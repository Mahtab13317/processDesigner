    ...
    if (structAlreadyExist) {
      ...
      if (alreadyExistsIndex !== null) {
        ...
        temp[alreadyExistsIndex].Member.forEach((el) => {
          if (+el.TypeId && +el.TypeId > +memTypeId) {
            memTypeId = el.TypeId;
          }
        });
