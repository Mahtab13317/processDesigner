  ...
  const daysValueHandler = (event) => {
    if (!checkDuplicateValues(event, "durationInfo.paramDays")) {
      ...
      setLocalRuleData((prevData) => {
        ...
        //getVarDetails(value);
        console.log("123", "days const", localStorage.getItem("daysConst"));
let tempConst=false
  ...
  useEffect(() => {
    ...
    if (
      localRuleData.ruleOpList[index]?.durationInfo?.variableIdHours
      === "0" &&
      localRuleData.ruleOpList[index]?.durationInfo?.varFieldIdHours
      === "0"
    ) {
      setIsHourConst(true);
    } else {
    ...
    if (
      localRuleData.ruleOpList[index]?.durationInfo?.variableIdSeconds === "0" &&
      localRuleData.ruleOpList[index]?.durationInfo?.varFieldIdSeconds
      === "0"
    ) {
      setIsSecConst(true);
    } else {
